    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-neutral-50 to-stone-50 p-4">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center py-8">
          <h1 className="text-5xl font-black text-gray-800 tracking-tight leading-tight mb-3">
        ...
        {/* Global Inputs */}
        <Card className="bg-white/90 backdrop-blur-sm border-stone-200/60 shadow-lg shadow-stone-200/20">
          <CardHeader className="pb-6">
            <CardTitle className="flex justify-between items-center font-bold text-xl text-gray-800">
              Your Business
              <Button
                variant="outline"
                size="sm"
          ...
          <CardContent className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <Label htmlFor="avgViews" className="text-base font-semibold text-gray-700">
                  Avg Views per Video
                </Label>
                <Input
                  id="avgViews"
            ...
            <div className="space-y-3">
              <Label className="text-base font-semibold text-gray-700">
                Annual Revenue Goal:{" "}
                <span className="text-xl font-bold text-gray-800">{formatCurrency(globals.revenueGoal)}</span>
              </Label>
              <p className="text-gray-600 font-medium">Monthly revenue: {formatCurrency(monthlyRevenue)}</p>
              <Slider
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 border-t border-stone-300/50">
              <div className="space-y-3">
                <Label className="text-base font-semibold text-gray-700">
                  YouTube Views → Landing Page:{" "}
                  <span className="text-lg font-bold text-gray-800">{globals.userCtr.toFixed(1)}%</span>
                </Label>
                <Slider
              ...
              <div className="space-y-3">
                <Label className="text-base font-semibold text-gray-700">
                  ...
                  <span className="text-lg font-bold text-gray-800">{globals.userLpConv.toFixed(1)}%</span>
                </Label>
                <Slider
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-stone-200/60 shadow-lg shadow-stone-200/20">
          ...
          <CardContent>
            <div className="mb-6 p-6 bg-gradient-to-r from-stone-200/40 to-neutral-200/40 rounded-lg border border-stone-300/30">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                ...
                <div>
                  <p className="font-semibold text-gray-700 text-base">
                    ...
                    <span className="text-xl font-bold text-gray-800">{formatCurrency(monthlyRevenue)}</span>
                  </p>
                  <p className="text-sm text-gray-600 mt-1">Over 12 months</p>
                </div>
              </div>
            </div>

            <div className="overflow-x-auto rounded-lg border border-stone-300/30">
              <table className="w-full">
                <thead className="bg-gradient-to-r from-stone-200/50 to-neutral-200/50">
                  <tr className="border-b border-stone-300/30">
                    <th className="text-left p-4 font-bold text-gray-800">Scenario</th>
                    <th className="text-left p-4 font-bold text-gray-800">CTR %</th>
                    <th className="text-left p-4 font-bold text-gray-800">LP Conv %</th>
                    <th className="text-left p-4 font-bold text-gray-800">Overall Conv %</th>
                    <th className="text-left p-4 font-bold text-gray-800">Views Needed</th>
                    <th className="text-left p-4 font-bold text-gray-800">Videos Needed</th>
                    <th className="text-left p-4 font-bold text-gray-800">Release Frequency</th>
                  </tr>
                </thead>
                <tbody className="bg-white/80">
                  {results.map((result, index) => (
                    <>
                      <tr
                        key={index}
                        className={`border-b border-stone-300/20 hover:bg-stone-100/40 transition-colors ${
                          result.isUser ? "bg-blue-100/70 border-blue-200/50 font-semibold" : ""
                        }`}
                      >
                        <td className="p-4 font-semibold text-gray-800">{result.scenario}</td>
                      ...
                      {result.isUser && (
                        <tr className="border-b-2 border-stone-400/40">
                          <td
                            colSpan={7}
                            className="p-3 text-center text-sm font-semibold text-gray-600 bg-gradient-to-r from-stone-200/30 to-neutral-200/30"
                          >
        ...
        <Card className="bg-gradient-to-r from-blue-100/70 to-indigo-100/70 border-blue-300/60 shadow-lg shadow-blue-100/20">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <button
                    ...
                    className="font-bold text-gray-800 text-lg hover:text-blue-600 transition-colors cursor-pointer"
                  >
                    Chet Callahan
                  </button>
                </div>
                <h3 className="text-2xl font-black text-gray-800 mb-3">The Creator MVP Playbook</h3>
                <p className="text-gray-600 font-medium">
                  Transform your professional experience into a strategic business on YouTube.
                </p>
              </div>
              <Button
                className="bg-blue-600 hover:bg-blue-700 text-white flex items-center gap-2 whitespace-nowrap font-bold px-6 py-3 text-base shadow-lg hover:shadow-xl transition-all"
                onClick={() => window.open("https://www.creator-mvp.com", "_blank")} // Replace # with your course URL
              >
                Learn More
